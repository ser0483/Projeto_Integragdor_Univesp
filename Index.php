...
<div class="container">
    ...
    <div id="pedidoContent" style="display: none;">
        <form id="pedidoForm">
            ...
            <button id="controleEstoque" type="button">Controle de Estoque</button>
        </form>
    </div>
</div>
...
<script>
    document.getElementById('loginForm').addEventListener('submit', function(event) {
        ...
        if ((username === 'luiz@cms.com.br' && password === '123') ||
            (username === 'julio@cms.com.br' && password === '123') ||
            (username === 'amilton@cms.com.br' && password === '123') ||
            (username === 'jenifer@cms.com.br' && password === '123') ||
            (username === 'elias@cms.com.br' && password === '123') ||
            (username === 'bruna@cms.com.br' && password === '123') ||
    ...
    document.getElementById('controleEstoque').addEventListener('click', function() {
        controleEstoque();
    });

        function controleEstoque() {
        window.open('./Partes/controle_estoque.php', '_blank');
        }
